  ...
  <div class="intro intro-single route bg-image" style="background-image: url(img/overlay-bg.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="intro-title mb-4">Information Technology</h2>
        ...
        <a href="it/mcqs.php">
            ...
            <center>
              <div style="text-align: center;margin-top: 2px;padding: 2px;">
                  <h2 style="color: #48abec;text-decoration: none;margin-top: 10px;" href="#">Mid Sem Mcqs and question papers</h2>
                  <h4 style="color: black;">Mid Sem Exam 2019-20 (JNEC)</h4>
                  <h5 style="color: black;">Information Technology</h5>
               </div>  
            </center>
